...
module.exports = {
  ...
  run: async (client, message, args) => {
    ...
    if (user.user.presence.activities.length) {
      ...
      if (user.nickname !== null) embed.addField("<:target:767819816274100244> Nickname", user.nickname)
      embed.addField("<:timer:767774254519287818> Joined At", moment(user.joinedAt).format("LLLL"))
        .addField("<:timer:767774254519287818> Account Created At", moment(user.user.createdAt).format("LLLL"))
        .addField("Common Information", `<:idcard:767819816400322580> ID: \`${user.user.id}\`\n<:hashtag:767818775029481493> Discriminator: ${user.user.discriminator}\n<:robot:767774254711439380> Bot: ${user.user.bot}\n<:delete:767822636024594452> Deleted User: ${user.deleted}`)
        .addField("<:badge:767819817742762004> Badges", newbadges.join(", ").toLowerCase() || "None")
